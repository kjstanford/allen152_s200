...
# meas_data = FET_sampling(b1500=b1500, smu_gate=smu_gate, smu_drain=smu_drain, smu_source=smu_source, gate_voltage=0.0, drain_voltage=0.0, source_voltage=0.0, hold_time=0.0, base_voltage=0.0, sampling_interval=0.1, nop=101, Irange='1 nA limited auto ranging', Vrange='2 V limited auto ranging')
